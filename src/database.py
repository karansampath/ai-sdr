...
class DatabaseManager:
    ...
    def _drop_all_tables(self, conn):
        """Drop all tables in correct order to handle foreign key constraints."""
        # Drop child tables first
        conn.execute("DROP TABLE IF EXISTS lead_pipeline_history")
        conn.execute("DROP TABLE IF EXISTS interactions")
        # Drop parent tables
        conn.execute("DROP TABLE IF EXISTS leads")
        conn.execute("DROP TABLE IF EXISTS scoring_criteria")
        conn.execute("DROP TABLE IF EXISTS pipeline_stages")
        
        # Drop sequences
        conn.execute("DROP SEQUENCE IF EXISTS leads_id_seq")
        conn.execute("DROP SEQUENCE IF EXISTS interactions_id_seq")
        conn.execute("DROP SEQUENCE IF EXISTS scoring_criteria_id_seq")
        conn.execute("DROP SEQUENCE IF EXISTS pipeline_stages_id_seq")
        conn.execute("DROP SEQUENCE IF EXISTS lead_pipeline_history_id_seq")
    
    def _create_leads_table(self, conn):
        """Create the leads table."""
        # Create sequence for auto-incrementing ID
        conn.execute("CREATE SEQUENCE leads_id_seq")
    ...
    def _create_interactions_table(self, conn):
        ...
        # Create sequence for auto-incrementing ID
        conn.execute("CREATE SEQUENCE interactions_id_seq")
    ...
    def _create_scoring_criteria_table(self, conn):
        ...
        # Create sequence for auto-incrementing ID
        conn.execute("CREATE SEQUENCE scoring_criteria_id_seq")
    ...
    def _create_pipeline_stages_table(self, conn):
        ...
        # Create sequence for auto-incrementing ID
        conn.execute("CREATE SEQUENCE pipeline_stages_id_seq")
    ...
    def _create_lead_pipeline_history_table(self, conn):
        ...
        # Create sequence for auto-incrementing ID
        conn.execute("CREATE SEQUENCE lead_pipeline_history_id_seq")
